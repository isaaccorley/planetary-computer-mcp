#!/usr/bin/env bun
/**
 * Test land use/land cover collections (LULC) with multiple AOIs
 * Collections: esa-worldcover, io-lulc-annual-v02, mtbs, nrcan-landcover
 */
...
// Land use/land cover collection test configurations
const COLLECTION_TESTS = [
  ...
  },
  {
    ...
    aois: ["fire_ca", "large_rockies", "mountain_alps"],
    max_cloud: 100,
  },
  {
    collection: "nrcan-landcover",
    datetime: "2020-01-01/2023-12-31",
    aois: ["small_seattle", "medium_chicago", "large_rockies"],
    max_cloud: 100,
  },
];
...
async function main() {
  console.log("=== LULC Collection Testing ===\n");
  console.log(
    "Testing land use/land cover collections: esa-worldcover, io-lulc-annual-v02, mtbs, nrcan-landcover\n"
  );
