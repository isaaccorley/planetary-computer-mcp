#!/usr/bin/env bun
/**
 * Test NAIP collections with multiple AOIs
 * Collections: naip
 */
...
// NAIP collection test configurations
const COLLECTION_TESTS = [
  {
    collection: "naip",
    datetime: "2020-01-01/2023-12-31",
    aois: ["tiny_sf"], // Very small AOI to test coordinate transformation
    max_cloud: 100,
  },
];
        ...
        send({
          ...
          params: {
            ...
            arguments: {
              ...
              // NAIP has high resolution (1m/pixel), don't constrain size to preserve native resolution
...
async function main() {
  console.log("=== NAIP Collection Testing ===\n");
  console.log("Testing NAIP collections: naip\n");
