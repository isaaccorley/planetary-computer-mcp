#!/usr/bin/env bun
/**
 * Test multiple AOIs of varying sizes and locations for each collection type
 * to find edge cases and bugs
 */
...
// Collection test configurations
const COLLECTION_TESTS = [
  ...
  },
  {
    ...
    aois: ["tiny_sf", "small_seattle", "medium_la", "rural_iowa"], // US only
    max_cloud: 100,
  },
  {
  ...
  // Land cover - test urban vs rural
  {
    collection: "esa-worldcover",
    datetime: "2021-01-01/2021-12-31",
    aois: ["small_seattle", "medium_la", "rural_iowa", "mountain_alps"],
    max_cloud: 100,
  },
  {
    collection: "io-lulc-annual-v02",
    datetime: "2022-01-01/2022-12-31",
    aois: ["small_seattle", "medium_chicago", "rural_iowa"],
    max_cloud: 100,
  },
  ...
  // MODIS - larger AOIs work better
  {
    collection: "modis-09A1-061",
    datetime: "2024-06-01/2024-06-30",
    aois: ["medium_la", "large_bay", "xlarge_southwest"],
    max_cloud: 50,
  },
];
...
async function main() {
  console.log("=== AOI Variation Testing ===\n");
  console.log("Testing multiple AOI sizes and locations for each collection type\n");
